...
from pimoouse_ros import MusicAction, MusicResult, MusicFeedback, MusicGoal
...
class BuzzerTest(unittest.TestCase):
    ...
    def test_music(self):
        ...
        self.assertEqual(goal.freqs,self.device_values,"inbalid feedback:" + ",".join([str(e) for e in self.device_values]))
